...
export function AnimatedAIChat({
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      const repoButton = document.querySelector("[data-repo-button]");
  ...
  useEffect(() => {
    if (selectedRepo) setShowRepoDropdown(false);
  }, [selectedRepo]);
      ...
      <div className="w-full max-w-2xl mx-auto relative">
        ...
        >
          <div className="text-center space-y-3">
            ...
            >
              <h1 className="text-3xl font-medium tracking-tight text-black dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-r dark:from-white/90 dark:to-white/40 pb-1">
          ...
          >
            ...
            {/* Command suggestion quick buttons */}
        ...
        <AnimatePresence>
          {isTyping && (
            <motion.div
              className="fixed left-1/2 bottom-8 transform -translate-x-1/2 backdrop-blur-2xl bg-white/[0.02] rounded-full px-4 py-2 shadow-lg border border-white/[0.05]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 20 }}
            >
