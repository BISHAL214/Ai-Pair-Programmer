...
import { ToggleTheme } from "@/themes/theme-toggler";
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "fixed top-5 inset-x-0 z-50 w-full",
        className
      )}
...
export const NavigationBar = ({
  ...
  return (
    <Navbar>
      <NavBody className="flex items-center justify-between bg-white/10 dark:bg-white/10">
        <NavbarLogo />
        <NavItems items={navItems} />
        <div className="flex items-center space-x-2">
          <NavbarButton className="shadow-none hover:bg-transparent cursor-pointer p-0">
            <ToggleTheme />
          </NavbarButton>
          {user ? (
