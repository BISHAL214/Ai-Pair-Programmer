...
export const projects = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can manage their own projects", {
      as: "permissive",
      for: "all",
      to: ["public"],
...
export const files = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can access files of their projects", {
      as: "permissive",
      for: "all",
      to: ["public"],
...
export const aiOverviews = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can read/write AI overview for their projects", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(EXISTS ( SELECT 1
...
export const explanations = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can read/write Explanations for their projects", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(EXISTS ( SELECT 1
...
export const chatMessages = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can chat only in their own projects", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(EXISTS ( SELECT 1
...
export const commits = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can view their commits", {
      as: "permissive",
      for: "all",
      to: ["public"],
      using: sql`(EXISTS ( SELECT 1
